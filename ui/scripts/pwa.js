...
$(document).ready(function(){
    ...
    var pwaVersion = '1.2.1';
    $('[data-pwa-version]').data('pwa-version', pwaVersion)

    //Creating Cookie System for PWA Hide
    function createCookie(e, t, n) {if (n) {var o = new Date;o.setTime(o.getTime() + 2 * n * 60 * 60 * 1e3);var r = "; expires=" + o.toGMTString()} else var r = "";document.cookie = e + "=" + t + r + "; path=/"}
    ...
    setTimeout(function(){
        $('.pwa-dismiss').on('click',function(){
            ...
            createCookie('PatialaCity_pwa_rejected_install', true, 1);
    ...
    if (isMobile.Android()) {
        ...
        function showInstallPromotion(){
            ...
            if($('#menu-install-pwa-android, .add-to-home').length){
                if (!readCookie('PatialaCity_pwa_rejected_install')) {
                    setTimeout(function(){
