...
import RegisterImageSRC from '../../Images/signup.jpg';
        ...
        <div className="container" style={{marginTop:'20px'}}>
            <div className="signup-content">
                <div className="signup-form" >
                    <h2 className="form-title" style={{fontFamily:'sans-serif'}}>Sign up</h2>
                ...
                <div className="signup-image">
                    <figure><img src={RegisterImageSRC} alt="Sign up" /></figure>
